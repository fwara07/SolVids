...
export default function Header(props: { handleSubmit: Function }) {
    ...
    <Popover className="relative bg-white">
      ...
      {openModal && (
        <div
          id="crypto-modal"
          aria-hidden="true"
          className="overflow-y-auto overflow-x-hidden fixed w-full md:inset-0 h-modal md:h-full align-middle justify-center"
        >
